...
<div class="container">
    <div class="row">
        <div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
            ...
            <a href="${pageContext.request.contextPath}/">${PRODUCT_CATEGORY.cname}&nbsp;&nbsp;&gt;</a>
            <%--<a>${PRODUCT.pname}</a>--%>
        </div>
        ...
        <div style="margin:0 auto;width:950px;">
            ...
            <div class="col-md-6">
                ...
                <div style="margin:10px 0 10px 0;">苏宁价: <strong style="color:#ef0101;">￥：${PRODUCT.shop_price}</strong> 参 考 价：
                ...
                <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                    ...
                    <div style="margin:20px 0 10px 0;;text-align: center;">
                        <%--加入到购物车 --%>
                        <a href="${pageContext.request.contextPath}/cart_servlet?method=addCartItemToCart&pid=${PRODUCT.pid}&quantity=1">
