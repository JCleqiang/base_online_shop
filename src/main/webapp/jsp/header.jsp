    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            <c:if test="${empty LOGIN_USER }">
                <li><a href="${pageContext.request.contextPath}/user_servlet?method=loginUI">登录</a></li>
                <li><a href="${pageContext.request.contextPath}/user_servlet?method=registerUI">注册</a></li>
            </c:if>
            <c:if test="${not empty LOGIN_USER }">
                <li><a href="#">欢迎：<span style="color: orange">${LOGIN_USER.name }</span></a></li>
                <li><a href="${pageContext.request.contextPath}/user_servlet?method=userLogout">退出</a></li>
